...
if [[ $1 ]] && [ -f $1 ]; then
    echo "Working with $1"
    echo "--------------------------------------------------------"
    eye --turtle $1 --pass --nope --quiet --no-qvars > grounded.n3
    ...
    echo "..."
    eye $SCRIPT_DIR/proc/targeting.n3 $SCRIPT_DIR/core/CoreConstraintsNode.n3 $SCRIPT_DIR/core/CoreConstraintsProp.n3 $SCRIPT_DIR/core/NotConstraint.n3 --turtle grounded.n3 --pass-only-new --nope --quiet > translated.n3
