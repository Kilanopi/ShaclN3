...
This is a project that aims to create a translation of SHACL into N3 Logic.
...
This was tested on the [SHACL testsuite](https://github.com/w3c/data-shapes/tree/gh-pages/data-shapes-test-suite/tests) . <br/>
EXAMPLE:
```./applyClean.sh translated.n3 MyDataGraph.n3```

You can alternatively use the shell script "run.sh" with the SHACL Document file as the first argument and the data graph file as the second argument. <br/>
